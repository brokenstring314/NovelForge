...
function getPresetForType(typeName?: string) : PerCardAIParams | undefined {
  ...
  const map: Record<string, PerCardAIParams> = {
    '金手指': { prompt_name: '金手指生成', response_model_name: 'SpecialAbilityResponse', temperature: 0.6, max_tokens: 8192, timeout: 60 },
    '一句话梗概': { prompt_name: '一句话梗概', response_model_name: 'OneSentence', temperature: 0.6, max_tokens: 8192, timeout: 60 },
    '故事大纲': { prompt_name: '一段话大纲', response_model_name: 'ParagraphOverview', temperature: 0.6, max_tokens: 8192, timeout: 60 },
    ...
    '章节大纲': { prompt_name: '章节大纲', response_model_name: 'ChapterOutline', temperature: 0.6, max_tokens: 8192, timeout: 60 },
